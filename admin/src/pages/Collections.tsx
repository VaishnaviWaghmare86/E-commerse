        ...
        {collections.map((col) => {
          ...
          return (
            <Card
              ...
              className="overflow-hidden flex flex-col justify-between cursor-pointer group hover:shadow-xl hover:border-[#7e14ff]/50 hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <CardContent className="p-4 flex-1 flex flex-col justify-between">
                <div>
                  <h4 className="text-sm font-bold text-slate-900 group-hover:text-[#7e14ff] transition-colors leading-snug">
                    {col.name}
                  </h4>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold text-[#7e14ff] flex items-center gap-0.5 group-hover:translate-x-0.5 transition-transform">
                      Open
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 p-3 bg-slate-50 border border-slate-200/80 rounded-xl text-xs">
              <div className="flex items-center gap-2 text-slate-600">
                ...
                <span className="font-mono text-[#7e14ff] bg-purple-50 px-2 py-0.5 rounded border border-purple-200">
              ...
              <button
                ...
                className="text-[#7e14ff] hover:underline font-semibold flex items-center gap-1 cursor-pointer"
              >
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-bold text-slate-800 flex items-center gap-2">
                    <Package className="w-4 h-4 text-[#7e14ff]" />
                    <span>Products in this Collection</span>
                    <span className="px-2 py-0.5 rounded-full bg-purple-100 text-[#7e14ff] text-xs font-bold">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-xs border border-slate-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#7e14ff]/20 focus:border-[#7e14ff]"
              />
            </div>
                ...
                availableProductsToAdd.map((prod) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-xs font-bold text-[#7e14ff] bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-lg transition-colors flex items-center gap-1 cursor-pointer shrink-0"
                    >
                  ...
                  {editImage ? (
                    ...
                    <div
                      ...
                      className={`border-2 border-dashed rounded-2xl p-7 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                        isEditDragging
                          ? 'border-[#7e14ff] bg-violet-50/70 ring-4 ring-[#7e14ff]/10 scale-[0.99]'
                          : 'border-slate-200 hover:border-[#7e14ff] bg-slate-50/70 hover:bg-violet-50/20'
                      }`}
                    >
                      <input
                        ...
                        className="hidden"
                      />
                      <UploadCloud className="w-6 h-6 text-[#7e14ff] mb-2" />
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <label className="flex items-center gap-2 cursor-pointer text-xs font-semibold text-slate-700">
                <input
                  ...
                  className="rounded text-[#7e14ff] focus:ring-[#7e14ff] w-4 h-4"
                />
                ...
                {image ? (
                  ...
                  >
                    <input
                      ...
                      className="hidden"
                    />
                    <div className="w-12 h-12 rounded-2xl bg-violet-100/70 text-[#7e14ff] flex items-center justify-center mb-2.5 group-hover:scale-110 transition-transform">
                      <UploadCloud className="w-6 h-6" />
                    </div>
                    <span className="text-xs font-bold text-slate-800 group-hover:text-[#7e14ff] transition-colors">
