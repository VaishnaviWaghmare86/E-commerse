        ...
        {collections.map((col) => {
          ...
          return (
            <Card
              ...
              className="overflow-hidden flex flex-col justify-between cursor-pointer group hover:shadow-xl hover:border-indigo-500/50 hover:-translate-y-1 transition-all duration-300"
            >
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 p-3 bg-slate-50 border border-slate-200/80 rounded-xl text-xs">
              <div className="flex items-center gap-2 text-slate-600">
                ...
                <span className="font-mono text-indigo-600 bg-pink-50 px-2 py-0.5 rounded border border-pink-200">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-bold text-slate-800 flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded-full bg-pink-100 text-indigo-600 text-xs font-bold">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-xs border border-slate-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
              />
            </div>
                ...
                availableProductsToAdd.map((prod) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-xs font-bold text-indigo-600 bg-pink-50 hover:bg-pink-100 border border-pink-200 rounded-lg transition-colors flex items-center gap-1 cursor-pointer shrink-0"
                    >
                  ...
                  {editImage ? (
                    ...
                    <div
                      ...
                      className={`border-2 border-dashed rounded-2xl p-7 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                        isEditDragging
                          ? 'border-indigo-500 bg-pink-50/70 ring-4 ring-indigo-500/10 scale-[0.99]'
                          : 'border-slate-200 hover:border-indigo-500 bg-slate-50/70 hover:bg-pink-50/20'
                      }`}
                    >
                      <input
                ...
                {image ? (
                  ...
                  >
                    <input
                      ...
                      className="hidden"
                    />
                    <div className="w-12 h-12 rounded-2xl bg-pink-100/70 text-indigo-600 flex items-center justify-center mb-2.5 group-hover:scale-110 transition-transform">
