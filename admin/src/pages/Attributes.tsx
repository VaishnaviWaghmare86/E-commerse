                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-xs font-semibold rounded-xl border transition-all cursor-pointer flex items-center gap-1.5 ${
                    exists
                      ...
                      : 'bg-pink-50 text-indigo-600 border-indigo-100 hover:bg-indigo-600 hover:text-white shadow-2xs'
                  }`}
            ...
            <div className="p-4 pt-0 border-t border-slate-100 mt-2">
              <div className="flex items-center gap-2 pt-3">
                <input
                  ...
                  className="flex-1 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-800 focus:outline-none focus:border-indigo-500 focus:bg-white"
                />
                <Button
                  size="xs"
                  variant="secondary"
            ...
            <div className="flex flex-wrap gap-1.5">
              {attributePresets.map((p) => (
                <button
                  ...
                  className="px-2.5 py-1 text-xs font-semibold bg-white text-pink-600 hover:bg-indigo-600 hover:text-white border border-pink-200 rounded-lg transition-colors cursor-pointer flex items-center gap-1 shadow-2xs"
                >
                  <Plus className="w-3 h-3" />
                  {p.name}
                </button>
