                ...
                <TableRow key={v.id}>
                  <TableCell>
                    <input
                      ...
                      className="bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1 text-xs w-28 font-medium focus:bg-white focus:outline-none focus:border-[#7e14ff]"
                    />
                  </TableCell>
                  <TableCell>
                    <input
                      ...
                      className="bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1 text-xs w-20 font-medium focus:bg-white focus:outline-none focus:border-[#7e14ff]"
                    />
                  </TableCell>
                  <TableCell>
                    <input
                      ...
                      className="bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1 text-xs w-36 font-mono focus:bg-white focus:outline-none focus:border-[#7e14ff]"
                    />
                  </TableCell>
                  <TableCell>
                    <input
                      ...
                      className="bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1 text-xs w-28 font-bold text-slate-800 focus:bg-white focus:outline-none focus:border-[#7e14ff]"
                    />
                  </TableCell>
                  <TableCell>
                    <input
                      ...
                      className="bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1 text-xs w-24 font-bold text-slate-800 focus:bg-white focus:outline-none focus:border-[#7e14ff]"
                    />
                  </TableCell>
